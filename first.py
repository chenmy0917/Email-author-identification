...
text1 = 'hello world!'
# text2 = "Python, from the Greek word (πύθων/πύθωνας), is a genus of nonvenomous pythons[2] found in Africa and Asia. Currently, 7 species are recognised.[2] A member of this genus, P. reticulatus, is among the longest snakes known."
#
...
print (count.most_common(10)) #去掉标点符号后对单词不加处理直接输出
...
print (count.most_common(10)) #去掉冠词之类词语之后输出
